#!/usr/bin/env bash
###############################################################################
## next_epoch_slots_localdb.sh is a wrapper script that uses cardano-cli     ##
...
## stake pool is going to be leader for any slot during the next epoch       ##
## from 36h before its start.                                                ##
##                                                                           ##
