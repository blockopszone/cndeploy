#!/usr/bin/env bash
###############################################################################
## current_epoch_slots.sh is a wrapper script that uses cardano-cli and cncli##
## to calculate if the specified stake pool is going to be leader for any    ##
## slot during the current epoch.                                            ##
##                                                                           ##
...
ES_CNCLI_DB="/opt/cardano/cnode/guild-db/cncli/cncli.db"
